...
/*
	var val=[];
	var mapcategory = ["pop","poverty","beachloss","landslide","floodfreq"]
	$('.panel input:checkbox:checked').each(function(){
		if (mapcategory.indexOf($(this).attr('name')) >=0 && val.indexOf($(this).attr('name'))== -1){
